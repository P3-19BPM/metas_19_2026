...
END AS situacao_zona,  
  ...
  WHERE 1=1
    AND oco.data_hora_fato BETWEEN '2026-01-01 00:00:00.000' AND '2026-12-31 23:59:59.000' -- Filtra ocorrências por período específico (jan/2025  até jul/2025)
...
--OCO.data_hora_fato BETWEEN '2024-01-01 00:00:00.000' AND '2025-04-30 23:59:59.000'
    AND OCO.natureza_codigo = 'A20028'  -- Considera ocorrências com natureza A20028 em qualquer data, e A20000 apenas se estiver no intervalo entre 01/01/2025 e 31/07/2025
